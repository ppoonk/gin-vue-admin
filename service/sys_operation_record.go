...
func DeleteSysOperationRecordByIds(ids model.IdsReq) (err error) {
...
//@param: id uint
//@return: sysOperationRecord model.SysOperationRecord, err error

func GetSysOperationRecord(id uint) (sysOperationRecord model.SysOperationRecord, err error) {
...
func GetSysOperationRecordInfoList(info model.SysOperationRecordSearch) (list interface{}, total int64, err error) {
	limit := info.PageSize
