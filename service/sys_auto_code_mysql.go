...
func (s *autoCodeMysql) GetDB(businessDB string) (data []model.Db, err error) {
	var entities []model.Db
...
// Author [piexlmax](https://github.com/piexlmax)
// Author [SliverHorn](https://github.com/SliverHorn)
func (s *autoCodeMysql) GetTables(businessDB string, dbName string) (data []model.Table, err error) {
	var entities []model.Table
...
// Author [piexlmax](https://github.com/piexlmax)
// Author [SliverHorn](https://github.com/SliverHorn)
func (s *autoCodeMysql) GetColumn(businessDB string, tableName string, dbName string) (data []model.Column, err error) {
	var entities []model.Column
	sql := `
