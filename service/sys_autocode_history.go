...
func CreateAutoCodeHistory(meta, structName, structCNName, autoCodePath string, injectionMeta string, tableName string, apiIds string, Package string) error {
...
// Author [SliverHorn](https://github.com/SliverHorn)
// Author [songzhibin97](https://github.com/songzhibin97)
func First(info *model.GetById) (string, error) {
	var meta string
	return meta, global.GVA_DB.Model(model.SysAutoCodeHistory{}).Select("request_meta").Where("id = ?", info.Uint()).First(&meta).Error
}

// Repeat 检测重复
// Author [SliverHorn](https://github.com/SliverHorn)
// Author [songzhibin97](https://github.com/songzhibin97)
func Repeat(businessDB, structName, Package string) bool {
	var count int64
...
// Author [SliverHorn](https://github.com/SliverHorn)
// Author [songzhibin97](https://github.com/songzhibin97)
func RollBack(info *model.RollBack) error {
	...
	err := DeleteApisByIds(ids)
	if err != nil {
		//global.GVA_LOG.Error("ClearTag DeleteApiByIds:", zap.Error(err))
		log.Println("ClearTag DeleteApiByIds:", err)
	}
	// 删除表
	if info.DeleteTable {
		if err = DropTable(md.BusinessDB, md.TableName); err != nil {
			//global.GVA_LOG.Error("ClearTag DropTable:", zap.Error(err))
			log.Println("ClearTag DropTable:", err)
		}
	}
	// 删除文件
...
// Author [SliverHorn](https://github.com/SliverHorn)
// Author [songzhibin97](https://github.com/songzhibin97)
func Delete(info *model.GetById) error {
	return global.GVA_DB.Where("id = ?", info.Uint()).Delete(&model.SysAutoCodeHistory{}).Error
}

// GetList 获取系统历史数据
// Author [SliverHorn](https://github.com/SliverHorn)
// Author [songzhibin97](https://github.com/songzhibin97)
func GetList(info model.PageInfo) (list []model.AutoCodeHistory, total int64, err error) {
	limit := info.PageSize
	offset := info.PageSize * (info.Page - 1)
	db := global.GVA_DB.Model(&model.SysAutoCodeHistory{})
	var entities []model.AutoCodeHistory
