...
func DeleteApi(api model.SysApi) (err error) {
	...
	success := ClearCasbin(1, entity.Path, entity.Method)
	if !success {
...
//@description: 分页获取数据,
//@param: api model.SysApi, info model.PageInfo, order string, desc bool
//@return: list interface{}, total int64, err error

func GetAPIInfoList(api model.SysApi, info model.PageInfo, order string, desc bool) (list interface{}, total int64, err error) {
	limit := info.PageSize
...
func GetAllApis() (apis []model.SysApi, err error) {
...
func GetApiById(id int) (api model.SysApi, err error) {
...
func DeleteApisByIds(ids model.IdsReq) (err error) {
	...
	if err != nil {
		...
		for _, sysApi := range apis {
			success := ClearCasbin(1, sysApi.Path, sysApi.Method)
			if !success {
